...
namespace Cassio.Produtos.Infra.Data.Migrations
{
    ...
    [Migration("20240416025218_AlteraRelacionamentoStockSupplier")]
    partial class AlteraRelacionamentoStockSupplier
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cassio.Produtos.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Cassio.Produtos.Domain.Entities.Stock", "Location")
                        .WithOne()
                        .HasForeignKey("Cassio.Produtos.Domain.Entities.Product", "LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cassio.Produtos.Domain.Entities.Supplier", "Supplier")
                        .WithOne()
                        .HasForeignKey("Cassio.Produtos.Domain.Entities.Product", "SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
